...
\begin{figure}
  \csvautotabular{../output/demographic.csv}
...
\begin{figure}
  \csvautotabular{../output/demographic-per-conf.csv}
...
\begin{figure}
  \csvautotabular{../output/demographic-delta.csv}
...
\centering
     \begin{subfigure}[b]{0.4\textwidth}
       \centering
       \csvautotabular{../output/overlap_Cross_conf_POPL.csv}
       \caption{Case of POPL}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.4\textwidth}
       \centering
       \csvautotabular{../output/overlap_Cross_conf_ICFP.csv}
...
\centering
     \begin{subfigure}[b]{0.4\textwidth}
       \centering
       \csvautotabular{../output/overlap_Cross_conf_PLDI.csv}
       \caption{Case of PLDI}
     \end{subfigure}
     \begin{subfigure}[b]{0.4\textwidth}
       \centering
       \csvautotabular{../output/overlap_Cross_conf_SPLASH.csv}
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    \centering
    \csvautotabular{../output/overlap_cross_year_POPL_ICFP.csv}
    \caption{POPL and ICFP}
  \end{subfigure}
  \begin{subfigure}[b]{0.3\textwidth}
    \centering
    \csvautotabular{../output/overlap_cross_year_POPL_PLDI.csv}
    \caption{POPL and PLDI}
  \end{subfigure}
  \begin{subfigure}[b]{0.3\textwidth}
    \centering
    \csvautotabular{../output/overlap_cross_year_POPL_SPLASH.csv}
    \caption{POPL and SPLASH}
  \end{subfigure}
  \begin{subfigure}[b]{0.3\textwidth}
    \centering
    \csvautotabular{../output/overlap_cross_year_ICFP_PLDI.csv}
    \caption{ICFP and PLDI}
  \end{subfigure}
  \begin{subfigure}[b]{0.3\textwidth}
    \centering
    \csvautotabular{../output/overlap_cross_year_ICFP_SPLASH.csv}
    \caption{ICFP and SPLASH}
  \end{subfigure}
  \begin{subfigure}[b]{0.3\textwidth}
    \centering
    \csvautotabular{../output/overlap_cross_year_PLDI_SPLASH.csv}
...
\begin{figure}
  \csvautotabular{../output/number_of_participations.csv}
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.4\textwidth}
    \centering
    \csvautotabular{../output/old_timer_POPL.csv}
    \caption{Case of POPL}
  \end{subfigure}
  \begin{subfigure}[b]{0.4\textwidth}
    \centering
    \csvautotabular{../output/old_timer_ICFP.csv}
    \caption{Case of ICFP}
  \end{subfigure}
  \\
  \begin{subfigure}[b]{0.4\textwidth}
    \centering
    \csvautotabular{../output/old_timer_PLDI.csv}
    \caption{Case of PLDI}
  \end{subfigure}
  \begin{subfigure}[b]{0.4\textwidth}
    \centering
    \csvautotabular{../output/old_timer_SPLASH.csv}
    \caption{Case of SPLASH}
  \end{subfigure}
...
\begin{figure}
  \begin{tabular}{|l|l|c|c|c|c|}
    ...
    \csvreader[head to column names]{../output/optimals.csv}{}%
