...
informative name?}} described in more detail in Section~\ref{sec:software}.
%
...
\caption{For each \event: location, number of participants and carbon cost,
  total and average per participant, in \gazunitbis.  \bcp{What about
    changing ``cost'' in most places to ``footprint''?}}
