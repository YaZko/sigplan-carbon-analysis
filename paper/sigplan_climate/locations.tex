...
\section{A Retrospective Speculation: Picking the Optimal
              Destination for  Past Conferences}
\label{sec:speculate}
%% \paragraph{A naive, retrospective, optimal choice}

\bcp{I propose removing this section, in the interest of getting the
  important parts (i.e., the rest :-) out in the world quickly.}
