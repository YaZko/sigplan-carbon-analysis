...
participants over time in SIGPLAN conferences. \yz{Should we scrap the three previous tables and only keep this Figure?}
...
\yz{Do we want to have this argument here?}
...
\begin{obs}
  ...
  among our dataset\bcp{Is that an accurate way of saying it?  I thought it
    ...
    instances of {\em any} of the conferences?}\yz{We have both data. This observation refers
    to the line ``ALL'' from Table 7}.
