...
\begin{table}
  ...
  \caption{Geographical distribution of participation conditioned by the
    ...
    The column \emph{Local} corresponds to the same continent as the conference.}
...
\caption{Overall and for each conference, the average number of instances a
  ...
  \rrbracket$. (The means and percentages are computed with
  respect to \emph{unique} participants.) \bcp{Are the upside down question
    marks intended?}\yz{Seems to be an encoding issue, compiling with xelatex solves it}}
